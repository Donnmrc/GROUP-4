...
This notebook trains and tests a neural network using PyTorch in order to classify images of weather conditions into 4 classes: Cloudy, Rain, Shine, Sunrise.
